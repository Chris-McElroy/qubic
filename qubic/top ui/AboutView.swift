    ...
    var usingTheAppPage: some View {
        ScrollView {
            VStack {
                ...
                Text("You can play games by pressing \"play\", \"solve\", or \"train\", and then \"start\". Once you start a game, you can see your name and your opponent’s name at the top, with the first player on the left and the second player on the right. When it’s your turn, your name (\"new player\" by default) glows. On your turn, you can tap on any open space to move there. Your moves are the same color as your name. You can rotate the board by swiping left or right. The right and left arrows at the bottom of the screen allow you to review the progress of the game by replaying previous moves. Note that you cannot make a move if you are on a previous move. When one player gets 4 in a row, a line appears connecting the row, and the board spins around. After the game ends, you can review previous moves by tapping the left arrow, and even test out alternative moves, which show up slightly transparent. Swiping up brings up the hints panel. When hints are enabled, this explains what opportunities you and your opponent have to win. By tapping \"wins\", you can see hints about making or stopping your wins, while tapping \"blocks\" brings up hints for your opponent’s wins. The hints are a powerful tool for learning from your games and becoming a strong player.\n").multilineTextAlignment(.leading)
