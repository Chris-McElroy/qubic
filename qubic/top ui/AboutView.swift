                    ...
                    VStack(spacing: 0) {
                        ZStack {
                            HStack(spacing: 0) {
                                ...
                                ScrollingPage(text: howToPlayText).frame(width: width)
                                ScrollingPage(text: usingTheAppText).frame(width: width)
                                ScrollingPage(text: developerBioText).frame(width: width)
